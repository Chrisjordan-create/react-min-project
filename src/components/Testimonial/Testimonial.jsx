     ...
     <div className='pt-20 bg-gray-200'>
      <div className='text-center mb-10 max-w-[600px] mx-auto space-y-3'>
         ...
         <p className='font-semibold lg:text-xl text-orange-500'>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla iusto, perspiciatis blanditiis
             esse nisi similique quod rem. Quasi repellat aliquam nulla beatae repellendus minus. Doloremque 
             dolorum autem est corporis repellat.
         </p>
       </div>
       <div>
               ...
               TestimonialData.map((data) => (
                 <div key={data.id} className='my-6 lg:my-8'>
                   <div className='flex flex-col gap-4 shadow-lg py-8 px-6 mx-4 rounded-xl bg-gray-700 relative'>
                     <div>
                       <img src={data.img} alt="NetError" className='rounded-full w-14 h-14 
                       lg:w-20 lg:h-20'/>
                     </div>
                     <div className='flex flex-col items-center pt-2 ig:pt-4'>
                     ...
                     <p className='text-white text-9xl font-serif absolute'>
