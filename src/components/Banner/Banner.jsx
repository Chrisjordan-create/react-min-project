...
import { FaCar, FaCreditCard } from "react-icons/fa6";
    ...
    <div className="min-h-[550px] justify-center items-center py-12 sm:p-0 flex bg-gray-950 text-white ">
      <div className="container">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-6 lg:gap-0 items-center">
            <img src={BannerImage} alt="BannerImage"  className="max-w-[400px] h-[350] w-full
          ...
          <div className="flex flex-col gap-6 sm:pt-0">
            ...
            <p className='text-sm lg:text-2xl text-gray-700 tracking-wide leading-5 md:leading-10 dark:text-white'>
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Esse debitis id atque perferendis veniam neque.
            </p>
            <div className='flex flex-col gap-4'>
              <div className='flex items-center gap-4'>
                <GrSecure className='text-2xl h-10 w-10 lg:text-4xl lg:w-14 lg:h-14 shadow-2xl p-2 
                rounded-full bg-violet-400 dark:bg-violet-600'/>
                <p className='text-sm lg:font-bold lg:text-lg'>Quality Products</p>
              </div>
              <div className='flex items-center gap-4'>
                <FaCar className='text-2xl h-10 w-10 lg:text-4xl lg:w-14 lg:h-14 shadow-2xl p-2 rounded-full
                 bg-orange-400 dark:bg-orange-600'/>
                <p className='text-sm lg:font-bold lg:text-lg'>Fast Delivery</p>
              </div>
              <div className='flex items-center gap-4'>
                <FaCreditCard className='text-2xl h-10 w-10 lg:text-4xl lg:w-14 lg:h-14 shadow-2xl p-2 
