...
import { FaMobileAlt, FaInstagram, FaFacebook, FaLinkedin, FaLocationArrow, } from 'react-icons/fa'
        ...
        <div className="grid md:grid-cols-2 pb-44 pt-5">
          <div className="py-8 px-4">
            <h1 className="text-xl lg:text-2xl font-bold sm:text-left text-justify mb-3 flex items-center gap-3">
              <img src={Logo} alt="Logo" className="max-w-[50px] lg:text-2xl" />
              teeWears
            </h1>
            ...
            <div className="py-8 px-4">
              ...
              <ul className="flex flex-col gap-3">
                {FooterLinks.map((link) => (
                  <li
                    key={link.title}
                    className="cursor-pointer hover:text-primary hover:translate-x-1 duration-300 text-gray-200 lg:font-bold"
                  >
