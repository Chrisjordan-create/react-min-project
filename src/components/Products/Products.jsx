    ...
    return(
      <div className="py-10 bg-gray-950 text-white leading-8">
        <div className="container">
          ...
          <div>
            <div className="grid grid-col-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 place-items-center gap-5">
              {
            ...
            <div className="flex justify-center">
               <button onClick={()=>toast.error('Please try again later, other wears are yet to come')} className="text-center
                 text-white mt-10 cursor-pointer bg-primary py-1 px-5 rounded-md">
                 View All
               </button>
            </div>
          </div>
