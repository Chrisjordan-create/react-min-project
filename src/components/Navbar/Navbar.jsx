...
import { Menu, TopProductsList  } from '../../data'
           ...
           lg:flex-row'>
            <h1 className='mb-5'>
              <a href='' onClick={() => {toast.success('Welcome Home!')}}
                ...
                lg:hover:scale-125 hover:scale-75 ease-in-out duration-500'>
                    teeWears
            ...
            <div className='flex gap-6 md:gap-4 lg:gap-6 items-center'>
              <div className='group relative'>
                <input type='text' placeholder='search' className='w-[150px]
                 md:w-[200px] lg:w-[300px] group-hover:w-[250px] lg:group-hover:w-[400px] transition-all duration-300 
                 rounded-full border border-gray-300 px-2 py-1 lg:px-4 lg:py-2 focus:outline-none focus:border-primary text-white'/>
                <IoMdSearch className='text-3xl lg:text-4xl absolute text-black bottom-4 right-2 translate-y-1/2'/>
              </div>
              <button onClick={handlePopup}className='bg-gradient-to-r from-primary to-secondary text-orange
               rounded-full py-1 px-6 transition-all duration-200 group gap-3 flex items-center'>
        ...
        <ul className='flex gap-7 lg:gap-40 items-center shadow-xl px-6'>
        {
          ...
          <li className='group relative cursor-pointer font-semibold lg:text-2xl'>
            <a href='/#' className='flex items-center gap-[2px] py-2 lg:py-4 lg:font-bold'>
              Trending
              <span>
                <FaSearch className='transition-all duration-200 group-hover:rotate-180 text-2xl lg:text-4xl' />
              </span>
            </a>
