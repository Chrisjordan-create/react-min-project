      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-20 md:gap-5 lg:gap-10 place-items-center px-10">
        {
          ...
          <div key={data.id} className="rounded-2xl bg-primary hover:bg-gray-800 hover:text-white relative shadow-xl
            duration-200 group max-w-[300px] lg:w-[350px] mb-10">
            <div className="h-[100px] md:h-[180px]">
              <img src={data.img} alt="ShirtImages" className="w-[120px] lg:w-[200px] 
              block mx-auto transform- transilation-y-20 group-hover:scale-105 duration-300"/>
            </div>
            <div className="p-4 text-center">
              <div className="w-full flex items-center justify-center gap-1 p-5">
              </div>
